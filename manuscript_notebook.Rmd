...
lines that say 'update' need to be updated before you post
...
unlist(lapply(list(scraps_AG1,scraps_AG2,scraps_AG3,scraps_AG4,scraps_AG5),FUN=function(x){sum(x[,3],na.rm=T)}))),
